...
class ImanageScreen extends StatefulWidget {
  const ImanageScreen({super.key});

  @override
  _ImanageScreenState createState() => _ImanageScreenState();
}

class _ImanageScreenState extends State<ImanageScreen> {
  late WebViewController _webViewController;
  double _progress = 0.0; // Track the loading progress.
  final String url = 'https://imanage.olaniwunajayi.net';  // Replace with your desired URL
