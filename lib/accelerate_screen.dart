...
class AccelerateScreen extends StatefulWidget {
  const AccelerateScreen({super.key});

  @override
  _AccelerateScreenState createState() => _AccelerateScreenState();
}

class _AccelerateScreenState extends State<AccelerateScreen> {
  late WebViewController _webViewController;
  double _progress = 0.0; // Track the loading progress.
  final String url = 'https://accelerate.olaniwunajayi.net';  // Replace with your desired URL
